  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-black to-gray-950 text-white p-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-6 p-4 bg-green-900/30 rounded-lg border border-green-700/50">
          <p className="text-sm text-green-200">
            Exercise your mind with thought-provoking puzzles and deep philosophical questions. 
            Challenge yourself and others to think beyond the ordinary.
          </p>
        </div>
