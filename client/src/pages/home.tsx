        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <CategoryCard
              ...
              onClick={() => window.location.href = '/whispers'}
            >
              <div className="space-y-3">
                {whispersLoading ? (
            ...
            <CategoryCard
              ...
              onClick={() => window.location.href = '/mind-maze'}
            >
              <div className="space-y-3">
                {mindMazeLoading ? (
            ...
            <CategoryCard
              ...
              onClick={() => window.location.href = '/night-circles'}
            >
              <div className="space-y-3">
                {nightCirclesLoading ? (
            ...
            <CategoryCard
              ...
              onClick={() => window.location.href = '/midnight-cafe'}
            >
              <div className="space-y-3">
                {midnightCafeLoading ? (
            ...
            <CategoryCard
              ...
              onClick={() => window.location.href = '/music-mood'}
            >
              <div className="space-y-3">
