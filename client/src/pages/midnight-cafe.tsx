        ...
        <div className="mb-8 p-6 bg-gradient-to-r from-amber-900/30 to-orange-900/30 rounded-lg border border-amber-700/50">
          <div className="flex items-center space-x-4 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-amber-300">A cozy space for casual conversations and companionship</p>
            </div>
          </div>
          <div className="grid grid-cols-3 gap-4 text-center">
            ...
            <div className="bg-black/30 rounded-lg p-3">
              <div className="text-amber-400 font-semibold">
                {new Set(midnightCafe.map(post => post.author)).size}
              </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center space-x-3 mb-2">
                        <h3 className="font-semibold text-amber-200">{post.author}</h3>
